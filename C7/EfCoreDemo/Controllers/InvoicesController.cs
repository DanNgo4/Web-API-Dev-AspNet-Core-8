...
[ApiController]
public class InvoicesController(InvoiceDbContext context, 
           ...
           : ControllerBase
{
    ...
    [HttpGet]
    [Route("search")]
    public async Task<ActionResult<IList<Invoice>>> SearchInvoices(string search)
    {
        if (context.Invoices == null)
            return NotFound();
    ...
    [HttpGet]
    [Route("paid")]
    public async Task<ActionResult<IList<Invoice>>> GetPaidInvoices()
    {
        if (context.Invoices == null)
            return NotFound();
    ...
    [HttpGet]
    [Route("status")]
    public async Task<ActionResult<IList<Invoice>>> GetInvoices(string status)
    {
        if (context.Invoices == null)
            return NotFound();
    ...
    [HttpGet]
    [Route("free-search")]
    public async Task<ActionResult<IList<Invoice>>> GetInvoices(string propertyName, 
                                                                string propertyValue)
    {
        ...
        var list = await context.Invoices
                                .FromSql($"SELECT * FROM Invoices WHERE {propertyName} = {value}")
                                .ToListAsync();
        return list;
    }
    ...
    [HttpGet]
    [Route("ids")]
    public ActionResult<IList<Guid>> GetInvoicesIds(string status)
    {
        if (context.Invoices == null)
            return NotFound();
    ...
    public async Task<IActionResult> UpdateInvoicesStatusAsOverdue(DateTime date)
    {
